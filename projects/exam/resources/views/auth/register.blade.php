            ...
            <div id="login">
                ...
                <form action="{{ route('register.store')}} " method="POST" novalidate>
                    ...
                    <fieldset class="clearfix">
                        ...
                        <p><span class="bi bi-person-fill"></span>
                            <input type="text" name="name"  Placeholder="Username" required></p>

                        <p><span class="bi bi-person-fill"></span>
                            <input type="text" name="family"  Placeholder="Family" required></p>

                        <p><span class="bi bi-lock-fill"></span>
                            <input type="text" name="email" Placeholder="Email" required></p>

                        <p><span class="bi bi-person-fill"></span>
                            <input type="text" name="mobile"  Placeholder="Mobile" required></p>

                        <p><span class="bi bi-lock-fill"></span>
                            <input type="password" name="password"  Placeholder="Password" required></p>

                        <div>
                            <span style="width:48%; text-align:left;  display: inline-block;"><a class="small-text" href="{{ route('login') }}">Login</a></span>
