            ...
            <div class="col-md-12 col-lg-10 col-xl-8">
                ...
                <textarea class="form-control" id="textAreaExample" rows="4"
                          style="background: #fff;"  name="body"  placeholder="لطفا کامنتی ارسال کنید"  ></textarea>
                                <label class="form-label" for="textAreaExample">Comment Name</label>
                                <input type="text" name="name" value="{{old('name')}}" class="form-control" >

                                <input type="hidden" name="commentable_id" value="{{$product->id}}" class="form-control" >
                                <input type="hidden" name="commentable_type" value="product" class="form-control" >
